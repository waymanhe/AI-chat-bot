...
from qwen_agent_local.llm import BaseChatModel
from qwen_agent_local.llm.schema import ASSISTANT, DEFAULT_SYSTEM_MESSAGE, USER, Message
from qwen_agent_local.log import logger
from qwen_agent_local.settings import (DEFAULT_MAX_REF_TOKEN, DEFAULT_PARSER_PAGE_SIZE, DEFAULT_RAG_KEYGEN_STRATEGY,
...
from qwen_agent_local.memory.es_memory import ESMemory
...
class Memory(Agent):
    ...
    def __init__(self,
        ...
        Args:
            ...
            memory_type: 'local'（默认，原有逻辑）或 'es'（用ESMemory）
        """
        self.cfg = rag_cfg or {}
    ...
    def _run(self, messages: List[Message], lang: str = 'en', **kwargs) -> Iterator[List[Message]]:
        ...
        if not rag_files:
            ...
            if query and self.rag_keygen_strategy.lower() != 'none':
                module_name = 'qwen_agent_local.agents.keygen_strategies'
