...
from qwen_agent_local.llm.function_calling import BaseFnCallModel
from qwen_agent_local.llm.schema import ASSISTANT, Message
from qwen_agent_local.log import logger
from qwen_agent_local.utils.utils import build_text_completion_prompt
...
class OpenVINO(BaseFnCallModel):
    ...
    Example passing pipeline in directly:
        ...
        tools = ['MyAiGen', 'code_interpreter']
