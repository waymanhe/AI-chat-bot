...
from qwen_agent_local.settings import DEFAULT_MAX_REF_TOKEN
from qwen_agent_local.tools.base import register_tool
...
from qwen_agent_local.utils.utils import has_chinese_chars
